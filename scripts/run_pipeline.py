...
CONFIGS: dict[str, dict[str, Any]] = {
    ...
    "jobthai": {
        "scraper": JobThaiScraper, "singleton": True,
        "output": "jobthai/jobs.csv",
    },
    "mycareersfuture": {
        "scraper": MyCareersFutureScraper, "singleton": True,
        "output": "mycareersfuture/jobs.csv",
    },
    "seek": {
        "scraper": SeekScraper,
        "slug": lambda r: _slug_col(r) or None,
    ...
    "vietnamworks": {
        "scraper": VietnamWorksScraper, "singleton": True,
        "output": "vietnamworks/jobs.csv",
    },
    "jobs_cz": {
