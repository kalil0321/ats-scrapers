...
from ats_scrapers.scrapers import ScraperRegistry, VietnamWorksScraper
from ats_scrapers.scrapers.vietnamworks import VietnamWorksScraper as _Scraper
...
def _fast_retries(monkeypatch: pytest.MonkeyPatch) -> None:
    import ats_scrapers.scrapers.vietnamworks as v
